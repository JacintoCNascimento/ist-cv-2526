...
img = imread('..\..\database\cherry.bmp');  %good example
img = imread('..\..\database\rabbit.jpg');  %good example
...
bw = img>thr;
figure(3),imshow(bw); colormap gray

%pause
% Also, perform the following experiments
% The range of the folloing threshods include the optinal Otsu Thr
