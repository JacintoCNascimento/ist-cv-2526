...
for i=1:N
    ...
    image(:,:,i)=imnoise(imgg,'salt & pepper',0.05);
...
figure;  
subplot(1,3,1); imagesc(imgg);colormap gray
subplot(1,3,2); imagesc(denoise_mean);colormap gray
subplot(1,3,3); imagesc(denoise_median);colormap gray
